...
void main (void)
{
  ...
  while(1)
  {
    ...
    if( flag_lock )
    {
      ...
      LPLD_FTM_PWM_ChangeDuty(FTM0,FTM_Ch0,2000);//电调锁定
      LPLD_FTM_PWM_ChangeDuty(FTM0,FTM_Ch1,2000);
      LPLD_FTM_PWM_ChangeDuty(FTM0,FTM_Ch2,2000);
      LPLD_FTM_PWM_ChangeDuty(FTM0,FTM_Ch3,2000);
    }
