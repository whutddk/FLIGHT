...
void UartDebug()
{
  ...
  if ( (uint32)UartData[8] == 6000 )
  {
    roll_quiet = Roll;
    pitch_quiet = Pitch;
    
//  _BZ_ON;
//  delay(70000);//延时5s让电调初始化
//  _BZ_OFF; 
//  delay(70000);//延时5s让电调初始化
//  _BZ_ON;
//  delay(70000);//延时5s让电调初始化
...
//    
//    ctrl.pitch.shell.aim = UartData[4];
//    
...
//    ctrl.pitch.core.kd = ctrl.roll.core.kd = UartData[7];
     ctrl.high.aim =  UartData[1];
    ctrl.high.kp = UartData[2];
      ctrl.high.ki = UartData[3];
      ctrl.high.kd = UartData[4];
  }
