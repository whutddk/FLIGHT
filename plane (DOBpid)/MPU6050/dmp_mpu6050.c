...
//
/****************************/
Dmp_Export_data  dmp_exportdata;
         ...
         if (sensors & INV_WXYZ_QUAT )
  	     {
		    	 ...
		    	 q2=quat[2] / q30;
		    	 q3=quat[3] / q30;
					 dmp_exportdata.pitch= asin(-2 * q1 * q3 + 2 * q0* q2)* 57.3; // pitch
	 	    	 dmp_exportdata.roll= atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2* q2 + 1)* 57.3; // roll
		    	 dmp_exportdata.yaw = atan2(2*(q1*q2 + q0*q3),q0*q0+q1*q1-q2*q2-q3*q3) * 57.3;
 					 
					 dmp_exportdata.gyro_outdata[0]=gyro[1]*0.02f;
					 dmp_exportdata.gyro_outdata[1]=gyro[0]*0.02f;
					 dmp_exportdata.gyro_outdata[2]=gyro[2]*0.02f;
					 push(6,dmp_exportdata.gyro_outdata[0]);
					 push(7,dmp_exportdata.gyro_outdata[1]);
//					 push(8,dmp_exportdata.gyro_outdata[2]);
