...
void CTRL_OUT()
{
  ...
  if (!flag_lock && !flag_dump && throttle >= 5100  )
  {  
    pwm_duty[0] = throttle - (int32)(ctrl.pitch.pid_out);
    
    pwm_duty[1] = throttle + (int32)(ctrl.pitch.pid_out);
      
    pwm_duty[2] = throttle + (int32)(ctrl.pitch.pid_out);
                                 
    pwm_duty[3] = throttle - (int32)(ctrl.pitch.pid_out);        
