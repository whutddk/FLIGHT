...
void CONTROL(float rol, float pit, float yaw)   
{
  ...
  /**加速度方向需要标定***/
  //roll
  ctrl.roll.core.error[1] = MPU6050_GYRO_LAST.Y ;
  
  ctrl.roll.core.kp_out = ctrl.roll.core.kp * (ctrl.roll.shell.pid_out + MPU6050_GYRO_LAST.Y /* Gyro_Gr*/ * RtA);
  ...
  //pitch
  ctrl.pitch.core.error[1] = MPU6050_GYRO_LAST.X ;
  
  ctrl.pitch.core.kp_out = ctrl.pitch.core.kp * (ctrl.pitch.shell.pid_out  + MPU6050_GYRO_LAST.X /* Gyro_Gr*/ * RtA);
  ...
  if ( ctrl.roll.core.pid_out > 800)
  {
    ctrl.roll.core.pid_out = 800;
  }
  if ( ctrl.roll.core.pid_out < -800 )
  {
    ctrl.roll.core.pid_out = -800;
  ...
  if ( ctrl.pitch.core.pid_out > 800 )
  {
    ctrl.pitch.core.pid_out = 800;
  }
  if ( ctrl.pitch.core.pid_out < -800 )
  {
    ctrl.pitch.core.pid_out = -800;
